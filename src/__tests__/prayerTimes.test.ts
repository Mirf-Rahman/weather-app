...
import { fetchPrayerTimes, getNextPrayer, getCurrentPrayerWindow, parseTime, PRAYER_METHODS } from '../api/prayerTimes';
...
describe('Prayer Times API', () => {
  ...
  describe('fetchPrayerTimes', () => {
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(fetchPrayerTimes(45.5017, -73.5673)).rejects.toThrow('Failed to fetch prayer times: API Error');
    });
  });
});
