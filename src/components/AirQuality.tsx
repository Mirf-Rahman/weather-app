...
const AirQuality: React.FC<AirQualityProps> = ({ data, theme }) => {
    ...
    switch (aqi) {
      case 1:
        return { 
          level: 'Good', 
          color: '#10b981', 
          description: 'Air quality is excellent. Ideal for all outdoor activities.' 
        };
      case 2:
        return { 
          level: 'Fair', 
  ...
  const pollutants = [
    { name: 'PM2.5', value: currentAQ.components.pm2_5, unit: 'μg/m³', icon: '🫁' },
    { name: 'PM10', value: currentAQ.components.pm10, unit: 'μg/m³', icon: '💨' },
